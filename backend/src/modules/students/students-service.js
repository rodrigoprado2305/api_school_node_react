...
const checkStudentId = async (id) => {
    ...
    if (!isStudentFound) {
        throw new ApiError(404, "checkStudentId-Student not found");
    }
}
...
const getAllStudents = async (payload) => {
    ...
    if (students.length <= 0) {
        throw new ApiError(404, "getAllStudents-Students not found");
    }
...
const getStudentDetail = async (id) => {
    ...
    if (!student) {
        throw new ApiError(404, "getStudentDetail-Student not found");
    }
