...
VALUES('Rodrigo Prado','desenvolvimentoti@gmail.com',1, now(),'$argon2id$v=19$m=65536,t=3,p=4$21a+bDbESEI60WO1wRKnvQ$i6OrxqNiHvwtf1Xg3bfU5+AXZG14fegW3p+RSMvq1oU', true, true)
RETURNING id;
...
update users set name = 'Rodrigo Prado', email = 'desenvolvimentoti@gmail.com' where id = 1
*/